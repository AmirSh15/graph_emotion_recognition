...
class Inception_layer(nn.Module):
    def __init__(self, input_dim):
        ...
        self.GCN_4 = GraphConv(self.num_layers, self.input_dim, int((self.input_dim + 128) / 4), 128)
        self.GCN_5 = GraphConv(self.num_layers, self.input_dim, int((self.input_dim + 64) / 4), 64)
...
class Graph_Inception(nn.Module):
    def __init__(self, num_layers, num_mlp_layers, input_dim, hidden_dim, output_dim,
        ...
        self.Inception_2 = Inception_layer(328)#328
        self.Inception_3 = Inception_layer(520)  # 328
        self.Inception_4 = Inception_layer(712)
        self.Inception_5 = Inception_layer(904)
    ...
    def forward(self, batch_graph):
        ...
        h = self.Inception_3(A, h, padded_neighbor_list)
        h = self.Inception_4(A, h, padded_neighbor_list)
        h = self.Inception_5(A, h, padded_neighbor_list)
